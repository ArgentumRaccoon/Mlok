...
bool VulkanUtils::ResultIsSuccess(VkResult Result)
{
    switch (Result) 
    {
        // Success Codes
...
std::string VulkanUtils::VulkanResultString(VkResult Result, bool bGetExtended)
{
    switch (Result) 
    {
        default:
